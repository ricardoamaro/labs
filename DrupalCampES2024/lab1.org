...
** Step 6: Access Your Drupal Site
   ...
   2. Forward port 8080 to the my-drupal service
      ...
      Forward port 8080 on your local machine to the service's port:

      #+begin_src bash
      kubectl port-forward svc/my-drupal 8080:80
      #+end_src

   2. If that didn't work, alternately you can forward port 8080 to the Drupal pod.
...
** Step 8: Test deleting the existing pods
...
** Step 9: Scale up the deployment to three from Drupal pods
